...
async function deployToLiveTestnet() {
  console.log('===========================================================');
  console.log('🌟 STELLAR GRANTS: LIVE TESTNET CONTRACT DEPLOYMENT 🌟');
  console.log('===========================================================\n');
  ...
  const wasmPath = path.resolve('contracts/grant_escrow/target/wasm32-unknown-unknown/release/grant_escrow.wasm');
  ...
  console.log('\n🎉 ===========================================================');
  console.log('🚀 STELLAR RIYA CONTRACT DEPLOYED SUCCESSFULLY ON TESTNET!');
  console.log('===========================================================');
